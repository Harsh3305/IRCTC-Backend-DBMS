...
function createTicketCluster(train_departure_time, source_id, destination_id, train_id, callback) {
    ...
    connection.connect((error) => {
        if (error) {
            ...
            const values = [[train_departure_time, train_id, source_id, destination_id, payment_id]];
            const sql_query = `INSERT INTO TICKET_CLUSTER (TRAIN_DEPARTURE_DATETIME, TRAIN_ID, SOURCE_ID, DESTINATION_ID, PAYMENT_ID) VALUES ? ;`;
